...
function Board() {
    ...
    const handleSave = (infoData)=> { // 에러 나길래 교수님 거 복붙해?? 봄???
    ...
    return (
        <div className=''>
            ...
            {modalOn && <Modal selectedData={selected} handleCancel={handleCancel} handleModifySubmit={handleModifySubmit}></Modal>} {/* 못 알아들은 게 투성이지만 얘한테 설명을 쓰자면... modalOn = true와 <뒤 어쩌고>가 둘 다 있으면(&&는 and) 실행되라 이 말이야.*/}
        </div>
    );
  }
